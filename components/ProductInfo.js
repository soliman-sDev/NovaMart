  ...
  return (
    <div className="md:flex md:items-center bg-[#d4dae3] dark:bg-[#0d0d0d]">
      ...
      <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2 ">
        <h3 className="dark:text-gray-200 text-gray-700 uppercase text-lg ml-2">
          {product.name}
        </h3>
        <span className="dark:text-gray-300 text-gray-500 mt-3 ml-2">
          ${product.price}
        </span>
        ...
        <div className="flex items-center mt-6">
          <button
            className="px-8 py-2 ml-2 mb-2 bg-black text-white dark:bg-white dark:text-black text-sm font-medium rounded hover:bg-[#0d0d0d] focus:outline-none focus:bg-[#0d0d0d]"
